...
const slides = [
  ...
  () => (
    <div className="slide">
      ...
      <p style={{ marginTop: '1.25rem', textAlign: 'center', maxWidth: '100%', fontSize: '1.3rem', fontWeight: 600 }} className="gold">A whole new economy is emerging as millions of individuals begin doing their inner work.</p>
    </div>
  ),
